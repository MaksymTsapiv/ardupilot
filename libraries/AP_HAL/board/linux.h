...
//    #define HAL_BARO_PROBE_LIST PROBE_BARO_I2C(BMP085, 10, 0x77)
//    #define HAL_INS_PROBE_LIST PROBE_IMU_I2C(Invensense, 10, 0x68, ROTATION_NONE)
//    #define HAL_MAG_PROBE_LIST PROBE_MAG_IMU_I2C(AK8963, mpu9250, 10, 0x0c, ROTATION_NONE)

    #define HAL_INS_PROBE_LIST PROBE_IMU_I2C(LSM6DS33, 15, 0x6b, ROTATION_PITCH_180)
    #define HAL_BARO_PROBE_LIST PROBE_BARO_I2C(BMP280, 15, 0x76)
    #define HAL_MAG_PROBE_LIST PROBE_MAG_I2C(LIS3MDL, 15, 0x1e, true,  ROTATION_NONE)
...
//    #define HAL_BARO_DEFAULT HAL_BARO_NONE
    ...
    * 240x240 crop rescaled to 64x64 */
    ...
    #define HAL_BOARD_SUBTYPE_LINUX_OBAL_V1_I2C
    ...
    #ifdef HAL_BOARD_SUBTYPE_LINUX_OBAL_V1_I2C
        #define HAL_BOARD_LOG_DIRECTORY "/home/pi/ardupilot/logs"
        #define HAL_BOARD_TERRAIN_DIRECTORY "/home/pi/ardupilot/terrain"
        #define HAL_BOARD_STORAGE_DIRECTORY "/home/pi/ardupilot"
...
//        #define HAL_INS_PROBE_LIST PROBE_IMU_SPI(Invensense, "mpu9250", ROTATION_NONE)
        #define HAL_INS_PROBE_LIST PROBE_IMU_I2C(LSM6DS33, 1, 0x6b, ROTATION_PITCH_180)
//        #define HAL_MAG_PROBE_LIST PROBE_MAG_IMU(AK8963, mpu9250, 0, ROTATION_NONE)
//        #define HAL_BARO_PROBE_LIST PROBE_BARO_I2C(BMP085, 1, 0x77)
        #define HAL_BARO_PROBE_LIST PROBE_BARO_I2C(BMP280, 1, 0x76)
//        #define HAL_BARO_PROBE_LIST PROBE_BARO_I2C(LPS2XH, 1, 0x5d)
        #define HAL_MAG_PROBE_LIST PROBE_MAG_I2C(LIS3MDL, 1, 0x1e, true,  ROTATION_NONE)
...
//        #define HAL_PROBE_EXTERNAL_I2C_COMPASSES
...
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_LINUX_REX_CUBYZ
    
    //#define HAL_BARO_ALLOW_INIT_NO_BARO
    
    // Activate SUB Model Configuratopm
    #define HAL_BOARD_SUBTYPE_LINUX_REX_CUBYZ_MPU_9250_SPI
    ...
    // GY-91 SPI Connection
    #ifdef HAL_BOARD_SUBTYPE_LINUX_REX_CUBYZ_MPU_9250_SPI
        #define HAL_BOARD_LOG_DIRECTORY "/home/pi/ardupilot/logs"
        #define HAL_BOARD_TERRAIN_DIRECTORY "/home/pi/ardupilot/terrain"
        #define HAL_BOARD_STORAGE_DIRECTORY "/home/pi/ardupilot"
        #define HAL_PARAM_DEFAULTS_PATH "/home/pi/ardupilot.parm"
