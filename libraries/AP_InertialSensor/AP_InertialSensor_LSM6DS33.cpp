...
AP_InertialSensor_LSM6DS33::AP_InertialSensor_LSM6DS33(AP_InertialSensor &imu,
...
AP_InertialSensor_LSM6DS33::probe(AP_InertialSensor &imu,
                                ...
                                enum Rotation rotation)
{
    ...
    auto sensor = new AP_InertialSensor_LSM6DS33(imu, std::move(dev), rotation);
...
void AP_InertialSensor_LSM6DS33::start()
{
    bool r;
    ...
    _dev->register_periodic_callback(1000,
                                     FUNCTOR_BIND_MEMBER(&AP_InertialSensor_LSM6DS33::_poll_data, void));
}

bool AP_InertialSensor_LSM6DS33::update()
{
...
void AP_InertialSensor_LSM6DS33::_check_err_reg()
{
#ifdef BMI160_DEBUG
    uint8_t v;
    bool r;
...
bool AP_InertialSensor_LSM6DS33::_configure_accel()
{
    bool r;
...
bool AP_InertialSensor_LSM6DS33::_configure_gyro()
{
    bool r;
...
bool AP_InertialSensor_LSM6DS33::_configure_int1_pin()
{
    bool r;
...
void AP_InertialSensor_LSM6DS33::_poll_data()
{
    _read_fifo();
}

bool AP_InertialSensor_LSM6DS33::_hardware_init()
{
    bool ret = false;
...
bool AP_InertialSensor_LSM6DS33::_init()
{
    DEV_PRINTF("dummy panic 1\n");
    AP_HAL::panic("dummy panic 2");
